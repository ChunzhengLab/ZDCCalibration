...
#ifndef  AliAnalysisTaskZDCvar_H
#define  AliAnalysisTaskZDCvar_H
...
class  AliAnalysisTaskZDCvar : public  AliAnalysisTaskSE
{
public:
  //  two  class  constructors
  AliAnalysisTaskZDCvar();
  AliAnalysisTaskZDCvar(const  char *name);
  //  class  destructor
  virtual ~AliAnalysisTaskZDCvar();
...
private:
  ...
  AliAnalysisTaskZDCvar(const AliAnalysisTaskZDCvar&);
  AliAnalysisTaskZDCvar& operator=(const AliAnalysisTaskZDCvar&);

  ClassDef(AliAnalysisTaskZDCvar,8);
};
