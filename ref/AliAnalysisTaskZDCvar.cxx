...
#define AliAnalysisTaskZDCvar_cxx
...
#include "TNtuple.h"
#include "THnSparse.h"
#include "AliAnalysisTaskZDCvar.h"
...
AliAnalysisTaskZDCvar::AliAnalysisTaskZDCvar () :
AliAnalysisTaskSE (),
fOutputList(0x0),
fHistList(0x0),
fQAList(0x0),
...
AliAnalysisTaskZDCvar::AliAnalysisTaskZDCvar(const  char* name)
...
void AliAnalysisTaskZDCvar::UserCreateOutputObjects ()
{
...
void AliAnalysisTaskZDCvar::UserExec(Option_t *)
{
...
void AliAnalysisTaskZDCvar::GetZDCQVectors(Double_t QAX, Double_t QAY, Double_t QCX, Double_t QCY)
{
...
Int_t AliAnalysisTaskZDCvar::GetCenBin(Double_t Centrality)
{
  Int_t CenBin=-1;
  ...
  return CenBin;
} // end of AliAnalysisTaskZDCvar::GetCenBin(Double_t Centrality)

//=====================================================================

void AliAnalysisTaskZDCvar::Terminate(Option_t */*option*/)
{
}